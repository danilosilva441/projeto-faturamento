...
// Importamos agora o SalvarOperacaoPayload diretamente do nosso "dicionário" de tipos.
import type { Operacao, SalvarOperacaoPayload } from '../types';
// E importamos apenas as funções do nosso serviço de API.
import { getOperacoes, createOperacao, updateOperacao, deleteOperacao } from '../services/apiService';
...
async function handleSalvarOperacao() {
  // Agora o TypeScript sabe exatamente qual é a "forma" deste objeto.
